 ...
 */
public class StructureDescriptor  extends WizardPanelDescriptor {
    public static final String IDENTIFIER = "STRUCTURE_PANEL";

    StructurePanel panel;

    public StructureDescriptor(DataModel dataModel) {

        panel = new StructurePanel(dataModel);
