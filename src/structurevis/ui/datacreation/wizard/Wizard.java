...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    public int showModalDialog() {
        ...
        final int x = (screenSize.width - wizardDialog.getWidth()) / 2;
        final int y = (screenSize.height - wizardDialog.getHeight()) / 2;
    ...
    private void initComponents() {
        ...
        //backButton = new JButton(BACK_ICON);
    ...
    public void addWizardListener(WizardListener l) {
        wizardListenerList.add(WizardListener.class, l);
    }

    public void removeWizardListener(WizardListener l) {
        wizardListenerList.remove(WizardListener.class, l);
    }

    public void firePanelChangedEvent(Object fromPanelIdentifier, Object toPanelIdentifier) {
        Object[] listeners = wizardListenerList.getListenerList();
