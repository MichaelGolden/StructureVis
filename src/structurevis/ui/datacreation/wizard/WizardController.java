...
public class WizardController implements ActionListener {
    ...
    private void nextButtonPressed() {
        ...
        Object nextPanelIdentifier = descriptor.getNextPanelDescriptor();
        int returnVal = 0;
        if(model.showErrors)
        {
            //returnVal = JOptionPane.showConfirmDialog(descriptor.getPanelComponent(), "There were errors on this page, are you sure want continue?", "Errors", JOptionPane.YES_NO_OPTION);
        }
        if (returnVal == 0) {
            if (nextPanelIdentifier instanceof WizardPanelDescriptor.FinishIdentifier) {
                wizard.close(Wizard.FINISH_RETURN_CODE);
            } else {
                wizard.setCurrentPanel(nextPanelIdentifier);
            }
        }

        wizard.firePanelChangedEvent(descriptor.getPanelDescriptorIdentifier(), nextPanelIdentifier);
    }
    ...
    private void backButtonPressed() {
        ...
        wizard.firePanelChangedEvent(descriptor.getPanelDescriptorIdentifier(), backPanelDescriptor);
