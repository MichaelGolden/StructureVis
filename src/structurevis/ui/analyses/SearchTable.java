...
public class SearchTable extends JPanel {
    ...
    public SearchTable(MainApp mainapp) {
        ...
        table.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    Location l = ((Location) table.getModel().getValueAt(row, 2));
                    
                    SearchTable.this.mainapp.openStructure(s);
                    SearchTable.this.mainapp.drawPanel1.setHighlightPosition(l.start, l.end+1);
    ...
    class TableDataModel extends AbstractTableModel {
        ...
        String[] columnNames = {"Search term", "Sequence", "Match Location", "Structure ID", "Structure Location", "Structure Length", "Score"};
        Class[] columnClasses = {String.class, String.class, Location.class, Integer.class, Location.class, Integer.class, Double.class};
    ...
    private static void createAndShowGUI() {
        ...
        SearchTable newContentPane = new SearchTable(null);
